...
export const RecordingStatusIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
...
export const SpeakerOffIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    {/* Speaker Body (from SpeakerOnIcon, without waves) */}
    ...
    {/* X mark / Slash */}
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 15L9 9m6 0l-6 6" />
  </svg>
);
